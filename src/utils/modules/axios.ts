import { useAuthStore, useEnvStore } from "@/store"
import { un, UnResponse, type UnConfig } from "@uni-helper/uni-network"
import { useUn, type UseUnOptions } from "@uni-helper/uni-network/composables"
...
async function onRejected(response: UnResponse) {
